...
<div class="form-box">
	...
	<form action="userSignup.do" method="post">
		...
		<input type="text" placeholder="UserName" id="userName" name="userName" class="input_field"><br><br>
	 
		<input type="text" placeholder="First Name" id="firstName" name="firstName" class="input_field">
		<br><br>
		<input type="text" placeholder="Last Name" id="lastName" name="lastName" class="input_field"><br><br>
	
		<input type ="number" placeholder="Phone Number" id="contactNo" name="contactNo" class="input_field"><br><br>
	
		<input type="password" placeholder="Password" id="pass" name="password" class="input_field"><br><br>
	
		<input type="date" placeholder="Dob" id="dob" name="dob" class="input_field"><br><br>
